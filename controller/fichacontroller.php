...
require_once(GPATH.'utils'.S.'vendor'.S.'tcpdf'.S.'config'.S.'config.php');
require_once(GPATH.'utils'.S.'vendor'.S.'tcpdf'.S.'tcpdf.php');
...
class FichaController extends Controller
{
    ...
    public static function criar_pdf($dados,$filename){
        ...
        $pdf->SetTitle('GPSPG - Sistema de Gestão de Processos Seletivos de Pós-Graduação');
        $pdf->SetSubject('Ficha de Inscrição');
        $pdf->SetKeywords('GPSPG,Ficha');
        ...
        $html = file_get_contents(GPATH.'pdf'.S.'ficha_modelo.html');
