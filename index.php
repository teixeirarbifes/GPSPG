...
<meta http-equiv="Pragma" content="no-cache">
  ...
  <!-- endinject -->
    ...
    <link href='/utils/css/modal.css?v=12' rel='stylesheet' />
    ...
    <script src="/assets/function.js?v=12"></script>
		<script src="/assets/js/captcha.js?v=12"></script>
		<script src="/ajax/ajax_submit.js??v=12"></script>
    ...
    <script src="/utils/change_form.js?v=12"></script>
