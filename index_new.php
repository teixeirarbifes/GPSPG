...
<div id="carregando" class="dialog-loading-wrapper" style="display:none;padding:10px">
  ...
  <div class="container-scroller">
    ...
    <nav class="navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
      ...
      <div class="navbar-menu-wrapper d-flex align-items-center justifya-content-end">
        <!--0button class="navbar-toggler navbar-toggler align-self-center" type="button" data-toggle="minimize">
      ...
      <ul class="nav">
          ...
          <?php if($controller->check_auth([3,4])) { ?>
            ...
            <a class="nav-link" data-toggle="collapse" href="#ui-admin" aria-expanded="false" aria-controls="ui-admin">
              ...
              <i style="color:black" class="menu-arrow"></i>
            </a>
