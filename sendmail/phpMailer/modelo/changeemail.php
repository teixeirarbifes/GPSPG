...
Seu e-mail foi alterado no seu cadastro. É necessário reativar a sua conta para efetivar a alteração.<span>
</p>
<p>
<b>O código de acesso é:</b>
</br></br>
<span style="font-size:25px;color:blue"><strong><?php echo $data['txt_chave2']?></strong></span>
</p>
<p>Caso não tenha realizado a alteração, entrar em contato pelo e-mail suporte.ppgep@gemad.net.</p>
</br>
<p>
Cordialmente,
</br></br>
