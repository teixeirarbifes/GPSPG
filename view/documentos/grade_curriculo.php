...
$funcao_excluir = "excluir_grade_curriculo";
?>
<script>
let modal_id = 0;
        ...
        <div class="row">
            <div class='col-md-12'>
                ...
                <div style="text-align:center">
                    <font color="red">Não há nenhum documento de curriculo apresentado para esta inscrição.</font>
                </div>
            <?php } ?>
        </div>
    </div>
