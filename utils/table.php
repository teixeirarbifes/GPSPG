        ...
        <thead>
            <tr>
                ...
                <th><?php if(!isset($novo) || $novo!=0){ ?>
                    <a onclick="go_link('?controller=<?php echo $txt_controller.$get_string;?>&method=criar&pag=<?php echo $params['pag']; ?>&num=<?php echo $params['limit']; ?>');" class="btn btn-success btn-sm">Novo</a></th>
                    <?php } ?>
            </tr>
        </thead>
        <tbody>
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap;">
                            ...
                            <?php }else if(isset($visualizar) && $visualizar==3){ ?>    
                                <a onclick="go_link('<?php echo $visualizar_url.$row->$id; ?><?=isset($visualizar_extra) ? '&'.$visualizar_extra : ''?>');" class="btn btn-primary btn-sm"><font color=white><?=$visualizar_txt?></font></a>    
                            <?php }else{ ?>
